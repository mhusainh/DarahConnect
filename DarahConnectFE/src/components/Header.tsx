              ...
              {!isLoggedIn ? (
                <>
                  ...
                  <HoverScale scale={1.02}>
                    <MagneticButton
                      onClick={handleLogin}
                      className="group flex items-center space-x-1.5 bg-white/80 backdrop-blur-sm border border-gray-200 text-gray-600 px-6 py-3 rounded-xl text-base font-medium hover:bg-gray-50 hover:border-gray-300 transition-all duration-300 shadow-sm"
                      strength={0.2}
                    >
                  ...
                  <div className="relative">
                    <HoverScale scale={1.02}>
                      <MagneticButton
                        ...
                        className="group flex items-center space-x-3 bg-white/90 backdrop-blur-sm border border-gray-200 px-4 py-3 rounded-xl hover:bg-gray-50 hover:border-gray-300 transition-all duration-300 shadow-sm"
                        strength={0.2}
                      >
                        ...
                        <div className="hidden md:block text-left">
                          <p className="text-sm font-semibold text-gray-900 leading-tight">Halo!</p>
                          <p className="text-sm text-gray-500 truncate max-w-32">{userName}</p>
                        </div>
                    ...
                    {showUserMenu && (
                      <FadeIn direction="down" delay={0.1}>
                        <div className="absolute right-0 mt-2 w-60 bg-white rounded-xl shadow-lg border border-gray-200 py-1.5 z-50">
